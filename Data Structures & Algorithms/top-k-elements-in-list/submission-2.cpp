...
public:
    vector<int> topKFrequent(vector<int>& nums, int k) {
        ...
        std::priority_queue<std::pair<int, int>, // pairs go inside 
                            std::vector<std::pair<int, int>>, // stored as vectors
                            std::greater<std::pair<int, int>>> minHeap; // comparator store as high .. low
